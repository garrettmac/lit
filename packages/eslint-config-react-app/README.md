...
This package includes the shareable ESLint configuration used by [Lit](https://github.com/garrettmac/lit).<br>
...
The easiest way to use this configuration is with [Lit](https://github.com/garrettmac/lit), which includes it by default.

**You don’t need to install it separately in Lit projects.**

## Usage Outside of Lit

If you want to use this ESLint configuration in a project not built with Lit, you can install it with following steps.
...
However, if you are using [Lit](https://github.com/garrettmac/lit) and have not ejected, any additional rules will only be displayed in the [IDE integrations](https://github.com/garrettmac/lit/blob/master/packages/react-scripts/template/README.md#displaying-lint-output-in-the-editor), but not in the browser or the terminal.
