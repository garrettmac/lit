...
const program = new commander.Command(packageJson.name)
  ...
  .on('--help', () => {
    ...
    console.log(
      `      ${chalk.cyan(
        'https://github.com/garrettmac/lit/issues/new'
      )}`
    );
    console.log();
  })
...
function install(root, useYarn, dependencies, verbose, isOnline) {
  return new Promise((resolve, reject) => {
    ...
    if (useYarn) {
      ...
      // https://github.com/garrettmac/lit/issues/3326.
...
// https://github.com/garrettmac/lit/pull/368#issuecomment-243446094
